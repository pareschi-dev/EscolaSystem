...
{
    public partial class RelatorioMateriaForm : Form
    {
        private DataTable dataTable = new DataTable();
        private PrintDocument printDocument = new PrintDocument();
        private int currentPage = 0;

        public RelatorioMateriaForm()
        {
            InitializeComponent();
        ...
        private void ConfigureDataTableColumns()
        {
            ...
            dataTable.Columns.Add("CargaHoraria", typeof(int));
        }

        private void LoadMateriasData()
        {
            dataTable.Rows.Clear();
            foreach (var materia in DataRepository.Materias)
            {
                dataTable.Rows.Add(
                    materia.Id,
                    materia.Nome,
        ...
        private void BuscarMaterias()
        {
            ...
            var materiasFiltradas = DataRepository.Materias
                .Where(materia => materia.Nome.Contains(criterio))
                .ToList();
        ...
        private void PrintDocument_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Relatório de Matérias", headerFont, Brushes.Black, leftMargin, yPos);
            yPos += headerFont.GetHeight() + 20;

            string[] headers = { "ID", "Nome", "Carga Horária" };
            float[] widths = { 50, 200, 100 };
